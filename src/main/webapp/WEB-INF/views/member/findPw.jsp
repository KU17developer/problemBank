...
<head>
    ...
    <script>
        $.ajax({
            ...
            data: {sessionData: "kfXjBIvKHGNyd8+2kNg8uvEiIKppiSnwwDCs7a1FzDLPwOyEhtzhjacJSgOXmPtSH8ycVv9DfvD5k6Q2ry91iA=="},
            dataType: 'json',
            cache: false,
        ...
        async function isSsoStudentLogout(){
            const response1 = await fetch("https://sso.chunjae.co.kr:446/api/auth/Validation?sessionData=" + encodeURIComponent('kfXjBIvKHGNyd8+2kNg8uvEiIKppiSnwwDCs7a1FzDLPwOyEhtzhjacJSgOXmPtSH8ycVv9DfvD5k6Q2ry91iA=='), {
                method: 'GET',
                cache: 'no-cache',
                headers: {
